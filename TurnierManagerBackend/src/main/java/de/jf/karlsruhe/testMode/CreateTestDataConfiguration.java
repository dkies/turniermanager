...
public class CreateTestDataConfiguration {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            // --- SETUP CODE ---
            LocalDateTime tournamentStart = LocalDateTime.of(2026, 3, 18, 21, 0);
...
// --- SETUP FÜR U17 ---
            ...
            League gruppeA_U17 = leagueRepository.save(League.builder()
                    .name("Gruppe A (U17)").tournament(sommerCup).ageGroup(u17).round(gruppenphase).teams(new ArrayList<>(u17Teams.subList(0, 12))).build());
